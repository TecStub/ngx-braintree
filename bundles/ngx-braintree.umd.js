(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-braintree', ['exports', '@angular/core', '@angular/common/http', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = global || self, factory(global['ngx-braintree'] = {}, global.ng.core, global.ng.common.http, global.rxjs, global.rxjs.operators, global.ng.common));
    ...
    var NgxBraintreeComponent = /** @class */ (function () {
        function NgxBraintreeComponent(service, configureDropinService, changeDetectorRef) {
            ...
            this.dropinLoaded = new core.EventEmitter();
            this.paymentStatus = new core.EventEmitter();
            this.payButtonStatus = new core.EventEmitter();
            // Optional inputs
        ...
        NgxBraintreeComponent.propDecorators = {
            dropinLoaded: [{ type: core.Output }],
            paymentStatus: [{ type: core.Output }],
            payButtonStatus: [{ type: core.Output }],
            clientTokenURL: [{ type: core.Input }],
            createPurchaseURL: [{ type: core.Input }],
            chargeAmount: [{ type: core.Input }],
            buttonText: [{ type: core.Input }],
            allowChoose: [{ type: core.Input }],
            showCardholderName: [{ type: core.Input }],
            enablePaypalCheckout: [{ type: core.Input }],
            enablePaypalVault: [{ type: core.Input }],
            currency: [{ type: core.Input }],
            locale: [{ type: core.Input }],
            enabledStyle: [{ type: core.Input }],
            disabledStyle: [{ type: core.Input }],
            hideLoader: [{ type: core.Input }],
            getClientToken: [{ type: core.Input }],
            createPurchase: [{ type: core.Input }]
        };
    ...
    exports.NgxBraintreeComponent = NgxBraintreeComponent;
    exports.NgxBraintreeModule = NgxBraintreeModule;
    exports.NgxBraintreeService = NgxBraintreeService;
    exports.ɵa = ConfigureDropinService;
    exports.ɵb = NgxBraintreeDirective;
    exports.ɵc = NgxBraintreePayDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=ngx-braintree.umd.js.map
